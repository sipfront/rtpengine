...
my ($jitter_a) = rcv($sock_ax, $port_bx, qr/^\x81\xc8\x00\x0c\x00\x00\x67\x89.{8}\x00\x00\x20\x80\x00\x00\x00\x03\x00\x00\x02\x04\x00\x00\x12\x34\x00\x00\x00\x00\x00\x00\x03\xea(.{4}).{4}.{4}\x81\xca\x00\x05\x00\x00\x67\x89\x01/s);
my ($jitter_b) = rcv($sock_bx, $port_ax, qr/^\x81\xc8\x00\x0c\x00\x00\x12\x34.{8}\x00\x00\x0c\xf8\x00\x00\x00\x03\x00\x00\x02\x04\x00\x00\x67\x89\x00\x00\x00\x00\x00\x00\x0f\xa2(.{4}).{4}.{4}\x81\xca\x00\x05\x00\x00\x12\x34\x01/s);
cmp_ok($jitter_a, '>', 0, 'generated RTCP reports measured jitter for A');
cmp_ok($jitter_b, '>', 0, 'generated RTCP reports measured jitter for B');

# wait for RTCP again
sleep(6);

my ($jitter_a_again) = rcv($sock_ax, $port_bx, qr/^\x81\xc8\x00\x0c\x00\x00\x67\x89.{8}\x00\x00\x20\x80\x00\x00\x00\x03\x00\x00\x02\x04\x00\x00\x12\x34\x00\x00\x00\x00\x00\x00\x03\xea(.{4}).{4}.{4}\x81\xca\x00\x05\x00\x00\x67\x89\x01/s);
my ($jitter_b_again) = rcv($sock_bx, $port_ax, qr/^\x81\xc8\x00\x0c\x00\x00\x12\x34.{8}\x00\x00\x0c\xf8\x00\x00\x00\x03\x00\x00\x02\x04\x00\x00\x67\x89\x00\x00\x00\x00\x00\x00\x0f\xa2(.{4}).{4}.{4}\x81\xca\x00\x05\x00\x00\x12\x34\x01/s);
is($jitter_a_again, $jitter_a, 'measured jitter for A is unchanged without new RTP');
is($jitter_b_again, $jitter_b, 'measured jitter for B is unchanged without new RTP');
